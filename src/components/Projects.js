                ...
                <div className="hero min-h-screen border-2 border-teal-400" style={{
                    ...
                    <div className="hero-content text-center text-neutral-content">
                        <div className="max-w-md">
                            ...
                            <button className="btn btn-xs btn-accent m-1"> <a href={'https://manufacturer-website-cli-b14a0.web.app/'}>Live site</a></button>
                ...
                <div className="hero min-h-screen border-2 border-teal-400" style={{
                    ...
                    <div className="hero-content text-center text-neutral-content">
                        <div className="max-w-md">
                            ...
                            <button className="btn btn-xs btn-accent m-1" ><a href={'https://dental-care-app.netlify.app/'}>Live site</a></button>
                ...
                <div className="hero min-h-screen border-2 border-teal-400" style={{
                    ...
                    <div className="hero-content text-center text-neutral-content">
                        <div className="max-w-md">
                            ...
                            <button className="btn btn-xs btn-accent m-1" ><a href={'https://warehouse-management-cli-a04c2.web.app/'}>Live site</a></button>
                ...
                <div className="hero min-h-screen border-2 border-teal-400 " style={{
                    ...
                    <div className="hero-content text-center text-neutral-content">
                        <div className="max-w-md">
                            ...
                            <button className="btn btn-xs btn-accent m-1" ><a href={'https://product-analysis-rumon.netlify.app/'}>Live site</a></button>
                ...
                <div className="hero min-h-screen border-2 border-teal-400" style={{
                    ...
                    <div className="hero-content text-center text-neutral-content">
                        <div className="max-w-md">
                            ...
                            <button className="btn btn-xs btn-accent m-1" ><a href={'https://tablet-bazar-rumon.netlify.app/'}>Live site</a></button>
                ...
                <div className="hero min-h-screen border-2 border-teal-400" style={{
                    ...
                    <div className="hero-content text-center text-neutral-content">
                        <div className="max-w-md">
                            ...
                            <button className="btn btn-xs btn-accent m-1" ><a href={'https://imiqbal27.github.io/panda-commerce-bootstrap/'}>Live site</a></button>
