        ...
        <div>
            <div className="navbar bg-teal-100">
                <div className="navbar-start">
                    ...
                    <Link to='/' className="btn btn-ghost normal-case text-xl text-sky-800 px-11">Iqbal's Portfolio</Link>
                </div>
                <div className="navbar-center hidden lg:flex">
                    <ul className="menu menu-horizontal font-semibold text-sky-800">
                        {menu}
                    </ul>
                </div>
